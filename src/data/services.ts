...
export const PORTFOLIO_CATEGORIES = [
  {
    id: 'matrimonios',
    name: 'Matrimonios',
    description: 'Sesiones de bodas y eventos especiales',
  },
  {
    id: 'naturaleza',
    name: 'Naturaleza',
    description: 'Fotografía de naturaleza y fauna',
  },
  {
    id: 'artistico',
    name: 'Artístico',
    description: 'Proyectos artísticos y conceptuales',
  },
  {
    id: 'marcas',
    name: 'Marcas',
    description: 'Fotografía de producto y contenido para marcas',
  },
];
...
export const PORTFOLIO_ITEMS = [
  {
    ...
    title: 'Matrimonio Danilo & Tamara',
    description: 'Sesión completa de boda',
    images: [
      '/portfolio/Matrimonio Danilo - Tamara/Matrimonio Tamara y Danilo-29.jpg',
      '/portfolio/Matrimonio Danilo - Tamara/Matrimonio Tamara y Danilo-77.jpg',
      '/portfolio/Matrimonio Danilo - Tamara/Matrimonio Tamara y Danilo-88.jpg',
      '/portfolio/Matrimonio Danilo - Tamara/Matrimonio Tamara y Danilo-149.jpg',
      '/portfolio/Matrimonio Danilo - Tamara/Matrimonio Tamara y Danilo-168.jpg',
      '/portfolio/Matrimonio Danilo - Tamara/Matrimonio Tamara y Danilo-192.jpg',
      '/portfolio/Matrimonio Danilo - Tamara/Matrimonio Tamara y Danilo-272.jpg',
    ],
    tags: ['Matrimonio', 'Exterior', 'Retrato'],
  },
  {
    id: 2,
    category: 'matrimonios',
    title: 'Matrimonio Mandy',
    description: 'Fotografía para redes sociales',
    images: [
      '/portfolio/Matrimonio Mandy/Matrimonio Mandy redes sociales-1.jpg',
      '/portfolio/Matrimonio Mandy/Matrimonio Mandy redes sociales-9.jpg',
      '/portfolio/Matrimonio Mandy/Matrimonio Mandy redes sociales-15.jpg',
      '/portfolio/Matrimonio Mandy/Matrimonio Mandy redes sociales-24.jpg',
      '/portfolio/Matrimonio Mandy/Matrimonio Mandy redes sociales-29.jpg',
      '/portfolio/Matrimonio Mandy/Matrimonio Mandy redes sociales-48.jpg',
      '/portfolio/Matrimonio Mandy/Matrimonio Mandy redes sociales-58.jpg',
      '/portfolio/Matrimonio Mandy/Matrimonio Mandy redes sociales-66.jpg',
      '/portfolio/Matrimonio Mandy/Matrimonio Mandy redes sociales-71.jpg',
      '/portfolio/Matrimonio Mandy/Matrimonio Mandy redes sociales-76.jpg',
    ],
    tags: ['Matrimonio', 'Redes Sociales', 'Lifestyle'],
  },
  {
    id: 3,
    category: 'naturaleza',
    title: 'Picaflores',
    description: 'Fotografía de fauna silvestre',
    images: [
      '/portfolio/Naturaleza/Picaflor-1.jpg',
      '/portfolio/Naturaleza/Picaflor-2.jpg',
      '/portfolio/Naturaleza/Picaflor-3.jpg',
    ],
    tags: ['Naturaleza', 'Fauna', 'Macro'],
  },
  {
    id: 4,
    category: 'artistico',
    title: 'Regio',
    description: 'Sesión urbana',
    images: [
      '/portfolio/Regio/DSC00105.JPG',
      '/portfolio/Regio/DSC00107.JPG',
      '/portfolio/Regio/DSC00111.JPG',
    ],
    tags: ['Urbano', 'Retrato', 'Exterior'],
  },
  {
    id: 5,
    category: 'artistico',
    title: 'Secret Garden',
    description: 'Proyecto artístico conceptual',
    images: [
      '/portfolio/Secret garden/Conexiones-7.jpg',
      '/portfolio/Secret garden/Fuego-8.jpg',
      '/portfolio/Secret garden/Infancia-5.jpg',
      '/portfolio/Secret garden/Particulas-4.jpg',
      '/portfolio/Secret garden/Portico-5.jpg',
      '/portfolio/Secret garden/Raices-6.jpg',
    ],
    tags: ['Artístico', 'Conceptual', 'Fine Art'],
  },
  {
    id: 6,
    category: 'marcas',
    title: 'Cola de Mono',
    description: 'Contenido de producto y lifestyle para marca',
    images: [
      '/portfolio/cm/cm_01.jpg',
      '/portfolio/cm/Untitled-3.jpg',
      '/portfolio/cm/cola de mono navideño-3.jpg',
      '/portfolio/cm/cola de mono navideño-4.jpg',
      '/portfolio/cm/IMG_20250319_203945.jpg',
      '/portfolio/cm/IMG_20250319_203950.jpg',
    ],
